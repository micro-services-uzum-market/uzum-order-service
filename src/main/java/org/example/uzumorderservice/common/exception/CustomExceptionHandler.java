...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleFeignException(FeignException e) {
        log.error(e.getMessage(), e);
        return ResponseEntity
    ...
    public ResponseEntity<CustomErrorResponse> handIllegalArgumentException(IllegalArgumentException e) {
        log.error(e.getMessage(), e);
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(CustomErrorResponse.builder()
    ...
    public ResponseEntity<CustomErrorResponse> handleNullPointerException(NullPointerException e) {
        log.error(e.getMessage(), e);
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(CustomErrorResponse.builder()
